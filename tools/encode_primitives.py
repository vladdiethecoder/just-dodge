...
def _format_primitive(primitive: dict) -> str:
    ...
    feature_window: {json.dumps(primitive['feature_window'], allow_nan=False)},
...
def format_library(
    ...
    today: str | None = None,
    generator_name: str = "tools/encode_primitives.py",
) -> str:
...
def create_library(
    ...
    library = format_library([primitive], generator_name=generator_name)
...
def _encode_kimodo_dir(args) -> None:
    ...
    for path in feature_paths:
        ...
        if os.path.exists(out_path):
            update_library(primitive, out_path, action_name, args.weapon, args.stance)
        else:
            create_library(primitive, out_path)
...
def update_library(
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        f.write(format_library(primitives, today, generator_name=generator_name))
...
def main():
    ...
    if os.path.exists(args.out):
        update_library(
            ...
            args.weapon,
            args.stance,
            generator_name="tools/encode_primitives.py",
        )
    else:
        create_library(primitive, args.out, generator_name="tools/encode_primitives.py")
