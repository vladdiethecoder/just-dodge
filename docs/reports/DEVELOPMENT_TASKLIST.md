...
Branch: `pvp-005-readable-live-motion`, published visual-harness implementation `397b7d9cdaba2619246a6367421e4de4d95f9936`; one worktree. Public `main` remains at historical ancestor `2677b4a7dd050e7f4c5ee03881aa16035e413a8b`.
Last updated: 2026-07-14
Active implementation unit: `PVP-005-READABLE-LIVE-THREE-ACTION-MOTION`.
Current PVP-005 blockers: the committed motion set is candidate-only. The pinned 16-view/background contract, candidate MRT renderer, five initial layers, first-person strips, and fail-closed render workflow now exist, but five diagnostic layers remain. Revision-bound candidate output fails complete-weapon crop for Strike 256/256 orbit samples, Block 68/256, Grab 142/256, and all 16 first-person samples per action; see `PVP005_CANDIDATE_VISUAL_MRT_RECEIPT.json`. No first-six-frame human judgments exist; `App::current_pose()` still returns reference matrices; and live Player mode still uses an independent camera-relative sword. PVP-004 closed the reproducible local package and automated OS input-path gates at its recorded ancestor revision; it did not establish PVP-005 motion admission, five human matches, or public redistribution rights.
...
Current status at published visual-harness revision `397b7d9cdaba2619246a6367421e4de4d95f9936` (2026-07-14): B.1.1 request isolation, fail-closed source/cache loading, numeric G1→24-bone transport, post-Reveal ARDY feasibility, quantized plan/replan packets, MotionBricks receipts, official G1 articulation data, integer hinge projection, independent-joint tracking, and a hash-bound three-action candidate packet exist. A deterministic Vulkan candidate harness now renders 16-view orbit sheets and real duel-camera strips with beauty, silhouette, object-ID, normals, and depth. Two complete local executions produced the identical visual-index SHA-256 `b8231b1bc0439c544e4e8893f1bb2b0202a46b26c6c05d3f5a74f06cd1ea7452`, but every action fails the current complete-weapon crop gate. The former Hugging Face authorization failure is historical. Runtime promotion remains blocked because `App::current_pose()` returns reference matrices, the complete PVP-005 visual/human gate has not passed, and the live sword/proxies do not yet share the solved pose source.
