...
Branch: `pvp-005-readable-live-motion`, published complete diagnostic-harness implementation `d84950f34d4a9e8fe9b08d4c47670bb4d88fea43`; one worktree. Public `main` remains at historical ancestor `2677b4a7dd050e7f4c5ee03881aa16035e413a8b`.
Last updated: 2026-07-14
Active implementation unit: `PVP-005-READABLE-LIVE-THREE-ACTION-MOTION`.
Current PVP-005 blockers: the committed motion set is candidate-only. The pinned 16-view/background contract, all ten required diagnostic layers, first-person strips, and fail-closed render workflow now exist. Revision-bound candidate output fails complete-weapon crop for Strike 256/256 orbit samples, Block 110/256, Grab 156/256, and all 16 first-person samples per action; see `PVP005_CANDIDATE_VISUAL_MRT_RECEIPT.json`. The correct right-hand grip anchor is within floating-point noise, but the second-hand grip misses by 289–352 mm for Strike, 452–496 mm for Block, and 508–685 mm for Grab. No first-six-frame human judgments exist; `App::current_pose()` still returns reference matrices; and live Player mode still uses an independent camera-relative sword. PVP-004 closed the reproducible local package and automated OS input-path gates at its recorded ancestor revision; it did not establish PVP-005 motion admission, five human matches, or public redistribution rights.
...
Current status at published visual-harness revision `d84950f34d4a9e8fe9b08d4c47670bb4d88fea43` (2026-07-14): B.1.1 request isolation, fail-closed source/cache loading, numeric G1→24-bone transport, post-Reveal ARDY feasibility, quantized plan/replan packets, MotionBricks receipts, official G1 articulation data, integer hinge projection, independent-joint tracking, and a hash-bound three-action candidate packet exist. A deterministic Vulkan candidate harness now renders 16-view orbit sheets and real duel-camera strips with all ten required layers. Two complete local executions produced the identical 540-image visual-index SHA-256 `c22eb9f364712a3b5de7640d29c41393216770843e217676d5f4413387bd959e`, but every action fails complete-weapon crop and two-hand grip coherence. The former Hugging Face authorization failure is historical. Runtime promotion remains blocked because `App::current_pose()` returns reference matrices, the complete PVP-005 visual/human gate has not passed, and the live sword/proxies do not yet share the solved pose source.
