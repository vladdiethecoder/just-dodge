...
pub const BONE_NAMES: [&str; BONE_COUNT] = [
    ...
    // 20..28: left leg (8)
    "LeftHip", "LeftFemur", "LeftKnee", "LeftTibia", "LeftFibula",
    "LeftAnkle", "LeftSubtalar", "LeftToeBase",
    // 28..36: right leg (8)
    "RightHip", "RightFemur", "RightKnee", "RightTibia", "RightFibula",
    "RightAnkle", "RightSubtalar", "RightToeBase",
    // 36..46: left arm (10)
    "LeftClavicle", "LeftScapula", "LeftShoulder", "LeftHumerus", "LeftElbow",
    "LeftRadius", "LeftUlna", "LeftWrist", "LeftHand", "LeftHandIK",
    // 46..56: right arm (10)
    "RightClavicle", "RightScapula", "RightShoulder", "RightHumerus", "RightElbow",
    "RightRadius", "RightUlna", "RightWrist", "RightHand", "RightHandIK",
    ...
    // 86..93: left foot (7)
    "LMetatarsal1", "LMetatarsal2", "LMetatarsal3", "LMetatarsal4", "LMetatarsal5",
    "LToeTip", "LFootIK",
    // 93..100: right foot (7)
    "RMetatarsal1", "RMetatarsal2", "RMetatarsal3", "RMetatarsal4", "RMetatarsal5",
    "RToeTip", "RFootIK",
    // 100..103: head (3)
    "Skull", "Jaw", "HeadIK",
];
...
pub fn bone_parent(i: usize) -> i32 {
    const PARENTS: [i32; BONE_COUNT] = {
        ...
        p[56] = 44; p[57] = 56; p[58] = 57;  // Thumb
        p[59] = 44; p[60] = 59; p[61] = 60;  // Index
        p[62] = 44; p[63] = 62; p[64] = 63;  // Middle
        p[65] = 44; p[66] = 65; p[67] = 66;  // Ring
        p[68] = 44; p[69] = 68; p[70] = 69;  // Pinky

        // Right fingers (parent = RightHand=54)
        p[71] = 54; p[72] = 71; p[73] = 72;
        p[74] = 54; p[75] = 74; p[76] = 75;
        p[77] = 54; p[78] = 77; p[79] = 78;
        p[80] = 54; p[81] = 80; p[82] = 81;
        p[83] = 54; p[84] = 83; p[85] = 84;

        // Left foot (parent = LeftToeBase=27, LeftSubtalar=26)
        p[86] = 27; p[87] = 27; p[88] = 27; p[89] = 27; p[90] = 27; // Metatarsals
        p[91] = 27;  // LToeTip → LeftToeBase
        p[92] = 26;  // LFootIK → LeftSubtalar

        // Right foot (parent = RightToeBase=35, RightSubtalar=34)
        p[93] = 35; p[94] = 35; p[95] = 35; p[96] = 35; p[97] = 35;
...
mod tests {
    ...
    fn all_non_root_bones_have_parent() {
        for i in 0..BONE_COUNT {
            if i != PELVIS {
                assert!(bone_parent(i) >= 0, "bone {i} ({}) has no parent", BONE_NAMES[i]);
            }
        }
    }
